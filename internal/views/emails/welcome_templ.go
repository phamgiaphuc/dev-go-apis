...
func Welcome(fullName string, verifyLink string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "\" target=\"_blank\" style=\"display:inline-block;text-decoration:none;background-color:#2563eb;color:#ffffff;font-size:14px;line-height:40px;padding:0 16px;margin:0 0 20px 0;\">Confirm your account</a><p style=\"color:#525252;font-size:14px;margin: 0 0 2px 0\">Or use this link:</p><a href=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		var templ_7745c5c3_Var4 templ.SafeURL
		templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.JoinURLErrs(verifyLink)
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/emails/welcome.templ`, Line: 31, Col: 24}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var4))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "\" target=\"_blank\" style=\"color:#2563eb;text-decoration:none;font-size:14px;\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		var templ_7745c5c3_Var5 string
		templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.JoinStringErrs(verifyLink[:80] + "...")
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/emails/welcome.templ`, Line: 35, Col: 32}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var5))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "</a><p style=\"color:#525252;font-size:14px;margin:20px 0 20px 0;\">Need help, or have questions? Please contact our support service via <a href=\"mailto:support@mail.acusdev.com\" style=\"color:#2563eb;text-decoration:none;\">support@mail.acusdev.com</a></p><p style=\"color:#525252;font-size:14px;margin:20px 0 0 0;\">Yours truly,</p><p style=\"color:#525252;font-size:14px;margin:2px 0 0 0;\">Acus Dev Team</p></td></tr></table></body></html>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
